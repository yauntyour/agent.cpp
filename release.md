...
| 平台 | 文件名 | 备注 |
|:-----|:-------|:-----|
| 🐧 Linux x86_64 | `agent-cpp-linux-v1.0.0.tar.gz` | 依赖 `libcurl` 和 `boost`（header-only） |
| 🪟 Windows x86_64 | `agent-cpp-windows-v1.0.0.zip` | 使用 MSYS2 MinGW64 编译，包含所有运行时 |
| 🍎 macOS (Intel/Apple Silicon) | `agent-cpp-macos-v1.0.0.tar.gz` | 通过 Homebrew 安装依赖后运行 |
